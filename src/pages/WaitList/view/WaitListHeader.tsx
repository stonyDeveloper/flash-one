...
// Alternative version using separate style prop if needed
const WaitListHeaderAlt = () => {
  const LEFT_SLIDE_VARIANT = {
    hidden: { opacity: 0, x: "-25vw" },
    visible: { opacity: 1, x: 0 }
  };
  ...
  return (
    <div className="flex items-center lg:justify-center gap-6 mt-[99px] lg:mt-[18px]">
      <motion.div
        ...
        variants={LEFT_SLIDE_VARIANT}
        transition={{ duration: 1 }}
        className="w-full  h-[0.5px] bg-gradient-to-r from-[rgba(6,106,111,0.1)] via-[rgba(206,210,212,0.5)] to-[rgba(6,106,111,0.1)]"
      />
